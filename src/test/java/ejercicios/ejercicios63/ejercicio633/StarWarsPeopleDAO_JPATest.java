...
class StarWarsPeopleDAO_JPATest {
...

    {
        ...
        human.setEyeColors("Brown, Blue, Green"); // Asigna los colores de ojos t�picos de los humanos
        human.setHairColors("Black, Brown, Blonde"); // Asigna los colores de cabello t�picos de los humanos
        ...
        human.setCreated(new Timestamp(System.currentTimeMillis())); // Establece la fecha de creaci�n actual
        human.setEdited(new Timestamp(System.currentTimeMillis())); // Establece la fecha de edici�n actual
